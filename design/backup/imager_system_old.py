...
from design.backup.apertures_old import Collimator
from design.backup.sources_old import Sources
from design.backup.detector_system_old import Detector_System
